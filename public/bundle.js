...
var app = (function () {
    ...
    /* src/Title.svelte generated by Svelte v3.24.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			if (default_slot) default_slot.c();
    			attr_dev(h1, "class", "font-display sm:font-body");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$2, 8, 2, 110);
    			attr_dev(input, "name", "email");
    			attr_dev(input, "type", "email");
    			attr_dev(input, "placeholder", "my form");
    			attr_dev(input, "class", "svelte-8rjtt6");
    			add_location(input, file$2, 9, 2, 145);
    			attr_dev(form, "class", "container mx-auto");
    			add_location(form, file$2, 7, 0, 75);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 23, 2, 561);
    			add_location(h3, file$3, 24, 2, 582);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$3, 27, 4, 626);
    			add_location(p, file$3, 25, 2, 604);
    			add_location(main, file$3, 15, 0, 397);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { name: 1, message: 0 });
